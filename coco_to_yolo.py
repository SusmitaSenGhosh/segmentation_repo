...
if __name__ == "__main__":
    base_input_path = "C:\\Users\\susmi\\ThreeV_cell_seg_SusmitaGhosh\\try_v2\\livecell"
    base_output_path = "C:\\Users\\susmi\\ThreeV_cell_seg_SusmitaGhosh\\try_v2\\livecell\\output"

    # Processing validation dataset (if needed)
    convert_to_yolo(
        input_images_path=os.path.join(base_input_path, "images\\livecell_train_val_images"),
        input_json_path=os.path.join(base_input_path, "livecell_coco_val.json"),
    ...
    convert_to_yolo(
        input_images_path=os.path.join(base_input_path, "images\\livecell_train_val_images"),
        input_json_path=os.path.join(base_input_path, "livecell_coco_train.json"),
    ...
    convert_to_yolo(
        input_images_path=os.path.join(base_input_path, "images\\livecell_test_images"),
        input_json_path=os.path.join(base_input_path, "livecell_coco_test.json"),
    ...
    create_yaml(
        ...
        train_path=os.path.join(base_output_path, "train\\images"),
        val_path = os.path.join(base_output_path, "valid\\images"),
        test_path=os.path.join(base_output_path, "test\\images")  # or None if not applicable
    )